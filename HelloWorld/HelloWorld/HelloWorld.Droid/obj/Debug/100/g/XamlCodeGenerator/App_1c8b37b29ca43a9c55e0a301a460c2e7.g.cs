...
namespace HelloWorld
{
	...
	partial class App : Windows.UI.Xaml.Application
	{
				private void InitializeComponent()
		{
			...
			.GenericApply((c0 => 
			{
				// Source C:\MyApps\unoplatform\HelloWorld\HelloWorld\HelloWorld.Shared\App.xaml (Line 1:2)
			...
			global::HelloWorld.Droid.GlobalStaticResources.Initialize();
			global::HelloWorld.Droid.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::HelloWorld.Droid.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::HelloWorld.Droid.Resource.Drawable);
			#endif
			// MergedDictionaries
			...
			// Source ..\..\..\..\..\..\..\HelloWorld.Shared\App.xaml (Line 1:2)
		}
...
{
	static class App_1c8b37b29ca43a9c55e0a301a460c2e7XamlApplyExtensions
	{
	}
}
